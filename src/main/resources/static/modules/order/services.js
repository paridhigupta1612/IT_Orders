...
.factory('OrderService',
    ...
    function ($http, $rootScope) {
        ...
        service.initOrder = function (serverUrl, owner, manager, supplier, core , RAM , storage , OS , callback) {
            console.log(manager);
            console.log(core);
        ...
        service.addComment = function (serverUrl, orderNumber, commentText, restrictedTo, callback) {
            ...
            $http({method: 'POST', url: serverUrl + "/containers/itorders/cases/instances/" + orderNumber + "/comments?" + restrictions,
            headers: {
                'Content-Type': 'application/json',
                'Accept': 'application/json'
            },
        ...
        service.UpdateComment = function (serverUrl, orderNumber, commentId, commentText, restrictedTo, callback) {
            ...
            $http({method: 'PUT', url: serverUrl + "/containers/itorders/cases/instances/" + orderNumber + "/comments/"+commentId + "?" + restrictions,
            headers: {
                'Content-Type': 'application/json',
                'Accept': 'application/json'
            },
        ...
        service.CloseCase = function (serverUrl, orderNumber, value, callback) {

        	$http({method: 'POST', url: serverUrl + "/containers/itorders/cases/instances/" + orderNumber,
                headers: {
                    'Content-Type': 'application/json',
                    'Accept': 'application/json'
                },
