        ...
        function ($scope, $rootScope, $location, OrderService, sharedStateService, appConfig, ModalService) {
            ...
            $scope.submitOrder = function() {
                ...
                OrderService.initOrder(appConfig.get('kieserver_url'), $scope.ownerInput,
                    $scope.managerInput,$scope.supplierInput,
        ...
        ['$scope', '$rootScope', '$route', '$routeParams', '$location', 'OrderService', 'appConfig',
            function ($scope, $rootScope, $route, $routeParams, $location, OrderService, appConfig) {
                ...
                $scope.addComment = function() {
                    ...
                    OrderService.addComment(appConfig.get('kieserver_url'), $scope.orderNumber, $scope.newcomment.text, $scope.restrictedTo, function (response) {
                ...
                $scope.saveComment = function() {
                    ...
                    OrderService.UpdateComment(appConfig.get('kieserver_url'), $scope.orderNumber, $scope.comment.id, $scope.comment.text, $scope.restrictedTo, function (response) {
                ...
                $scope.closeOrderConfirmation = function(orderNumber) {
                    $scope.orderNumber = orderNumber;
                    $scope.closecomment = {};
                }
                ...
                $scope.closeOrder = function() {
                    ...
                    OrderService.CloseCase(appConfig.get('kieserver_url'), $scope.orderNumber, $scope.closecomment.text, function (response) {
